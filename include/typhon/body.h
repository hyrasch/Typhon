...
namespace typhon {
	...
	public:
		...
		//Vélocité linéaire du RigidBody (WorldSpace)
		Vector3 velocity;
		...
		//Somme des forces à appliquer à la prochaine integration 
		Vector3 forceAccum;

		//Somme des couples à appliquer à la prochaine integration
		Vector3 torqueAccum;

        //Damping utilisé pour les mouvements linéaires
        real linearDamping;

        //Damping utilisé pour les mouvements angulaires
        real angularDamping;
